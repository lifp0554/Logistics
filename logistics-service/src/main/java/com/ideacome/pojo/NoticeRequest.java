...
public class NoticeRequest {
	...
	private String billstatus = "";//包括got、sending、check三个状态
	private String message = "";//监控状态相关消息
	private String autoCheck;//快递公司编码是否出错
	private String comOld;//提交的原始的快递公司编码
	private String comNew;//纠正后的新的快递公司编码
	private Result lastResult = new Result();//最新查询结果
	private Result destResult = new Result();//最新查询结果
